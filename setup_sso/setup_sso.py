...
def main(
    ...
    end_of_policy = '"}}]}'
    policy_document = start_of_policy + setup_sso.saml_provider + end_of_policy
    ...
    setup_sso.create_role(admin_role_name, admin_policy_arn, policy_document)
    read_role_name = 'SSOViewOnlyAccess'
    read_policy_arn = f"arn:{aws_partition}:iam::aws:policy/job-function/ViewOnlyAccess"
    setup_sso.create_role(read_role_name, read_policy_arn, policy_document)
